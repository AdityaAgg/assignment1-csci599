...
class TestFCReLU(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):        
		self.net = sequential(fc(np.prod((3, 4)), 10, name = "param_name"), relu("relu")
			########## TODO: ##########
...
class SmallFullyConnectedNetwork(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):
		self.net = sequential(
			########## TODO: ##########
			fc(4, 30, name = "layer_1"), relu("relu_layer_1"), fc(30, 7, name="layer_2"), relu("relu_layer_2")
			########### END ###########
		)
...
class TinyNet(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):
		...
		self.net = sequential(
			########## TODO: ##########
			fc(3072, 100, name="fc1"), relu("fc1_relu"),
			fc(100, 10, name="fc2")
			########### END ###########
		)
